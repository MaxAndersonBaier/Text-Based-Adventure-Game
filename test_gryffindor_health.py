...
from game import gryffindor_health


class TestGryffindorHealth(TestCase):
    ...
    def test_update_character_dictionary_level_1(self):
        ...
        character['lvl'] = 1
        actual = gryffindor_health(character)
    ...
    def test_update_character_dictionary_level_3(self):
        ...
        character['lvl'] = 3
        actual = gryffindor_health(character)
        expected = {"name": "", "HP": 20, "max_HP": 50, "class": "1", "lvl": 3, "exp": 0, "damage": "",
                    "recovery_rate": "", "attack_probability": ""}
        self.assertEqual(actual, expected)
