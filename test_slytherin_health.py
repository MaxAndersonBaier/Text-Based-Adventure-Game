...
from game import slytherin_health


class TestSlytherinHealth(TestCase):
    ...
    def test_update_character_dictionary_level_1(self):
        ...
        character['lvl'] = 1
        actual = slytherin_health(character)
    ...
    def test_update_character_dictionary_level_2(self):
        ...
        character['lvl'] = 2
        actual = slytherin_health(character)
        expected = {"name": "", "HP": 20, "max_HP": 25, "class": "1", "lvl": 2, "exp": 0, "damage": "",
                    "recovery_rate": "", "attack_probability": ""}
        self.assertEqual(actual, expected)
    ...
    def test_update_character_dictionary_level_3(self):
        ...
        character['lvl'] = 3
        actual = slytherin_health(character)
        expected = {"name": "", "HP": 20, "max_HP": 30, "class": "1", "lvl": 3, "exp": 0, "damage": "",
                    "recovery_rate": "", "attack_probability": ""}
        self.assertEqual(actual, expected)
